...
# %% auto 0
__all__ = ['use_fused_adam', 'LoopingDataSet', 'NormGradTrainCB', 'get_lr', 'CosineLR', 'get_optimizer', 'GradAccuTrainCB',
           'ScheduleCB', 'RecordCB', 'GradAccuTimeCallback']
...
# %% ../nbs/pt6-hyperparam.ipynb 40
class GradAccuTrainCB(TrainCB):
    ...
    def after_backward(self, learn):
        if learn._step_count % learn.accu_steps == 0:
            learn.grad_nom = nn.utils.clip_grad_norm_(learn.model.parameters(), 1.0) 
...
# %% ../nbs/pt6-hyperparam.ipynb 43
class GradAccuTimeCallback(Callback):

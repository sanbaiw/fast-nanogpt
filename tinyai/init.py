...
# %% auto 0
__all__ = ['clean_ipython_hist', 'clean_tb', 'clean_mem', 'init_weights', 'ResidualLinear', 'is_residual', 'get_model',
           'InitWeightsCB']
...
# %% ../nbs/pt4-initialization.ipynb 24
def init_weights(m):
    std=0.02
